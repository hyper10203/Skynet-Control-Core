...
MODEL_PROFILES = {
    ...
    "rtx3050-offline-max": {
        "label": "RTX 3050 Offline Max",
        "tier": "Recommended For This Laptop",
        "summary": "Best practical offline Ollama stack for a 24 GB RAM / 6 GB VRAM laptop: one stronger anchor model plus smaller helpers, without thrashing across several giant models.",
        "roles": {
        ...
        "contexts": {
            ...
            "operator_fast": 4096,
            "reasoning_primary": 8192,
            "reasoning_secondary": 4096,
            "reasoning_tertiary": 4096,
            "coder": 8192,
            "critic": 6144,
        },
        "notes": [
            "This is the highest-value offline stack for your laptop without trying to hot-swap multiple huge models through 6 GB of VRAM.",
            "Qwen3 8B is reused as the anchor across orchestration, primary reasoning, and critique, which is much more stable than mixing Qwen3.6, Gemma4 31B, and Llama3.3 70B in one loop.",
            "Mistral 7B and Llama3 stay as lighter side voices, and Qwen2.5-Coder remains the practical coding worker on this machine.",
        ],
        "recommended_pulls": ["qwen3:8b"],
    },
    "balanced-2026": {
        "label": "Balanced 2026",
    ...
    "giant-anchor": {
        "label": "Giant Anchor",
        "tier": "Manual / One Big Brain",
        "summary": "Manual-only profile that reuses one oversized anchor model across roles. Not recommended for the always-on loop on this laptop.",
        "roles": {
            "orchestrator": "qwen3.6:latest",
            "operator_fast": "qwen2.5",
            "reasoning_primary": "qwen3.6:latest",
            "reasoning_secondary": "mistral:7b-text-fp16",
            "reasoning_tertiary": "qwen2.5",
            "coder": "deepseek-coder-v2:16b",
            "critic": "qwen3.6:latest",
        },
        "contexts": {
            "orchestrator": 8192,
            "operator_fast": 4096,
        ...
        "notes": [
            "Best way to use a giant model on a 24 GB RAM / 6 GB VRAM laptop is to reuse one giant anchor, not swap several giant models through the loop.",
            "This avoids the qwen3.6 -> gemma4 -> llama3.3 -> deepseek-coder-v2 memory thrash that caused empty replies and 500 errors.",
            "If you truly want llama3.3 70B or gemma4 31B in the hot path, you need much more VRAM or a much slower CPU-only workflow.",
            "Keep this profile out of auto-detected defaults on this machine.",
        ],
        "recommended_pulls": [],
    },
}
